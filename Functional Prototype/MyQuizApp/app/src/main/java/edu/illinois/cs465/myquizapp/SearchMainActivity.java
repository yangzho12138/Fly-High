...
import edu.illinois.cs465.myquizapp.databinding.ActivitySearchMainBinding;
...
public class SearchMainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collectionButton = (ImageButton) findViewById(R.id.collectionButton);
        collectionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Intent collectionView = new Intent(getApplicationContext(), FlightKeeperMainActivity.class);
